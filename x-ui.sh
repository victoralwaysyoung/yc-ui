...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/victoralwaysyoung/yc-ui/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update_menu() {
    ...
    wget -O /usr/bin/x-ui https://raw.githubusercontent.com/victoralwaysyoung/yc-ui/main/x-ui.sh
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/victoralwaysyoung/yc-ui/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/victoralwaysyoung/yc-ui/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N https://github.com/victoralwaysyoung/yc-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
